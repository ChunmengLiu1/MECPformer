...
def hide_patch_ss(img, num_seg):

    _,w,h = img.shape
    uncontribute_num = 0
    contribute_num = 0
    # You can value n_segments to set the number of super-pixels
    spx = slic(img.permute(1,2,0),compactness=10,n_segments=num_seg,start_label = 1)
...
def ResizeLong(img, min_long, max_long):
